 ...
 */
const calculerPrixTTC = (Prix_Unitaire, Taux_TVA, Quantite) => Prix_Unitaire * Quantite + (Prix_Unitaire * Quantite * Taux_TVA) / 100;

// On écoute les click du bouton "Calculer"
document.getElementById('calculate').addEventListener('click', () => {
  // On détermine le prix toute taxe comprise des produits
  const prixTTC = calculerPrixTTC(parseFloat(champTextePU.value), parseFloat(champTexteTVA.value), parseFloat(champTexteQT.value));
